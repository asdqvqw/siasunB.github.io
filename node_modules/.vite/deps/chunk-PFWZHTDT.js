  ...
  "node_modules/docxtemplater/js/lexer.js"(exports, module) {
    ...
    module.exports = {
      ...
      parse: function parse(xmlparsed, delimiters, syntaxOptions) {
        ...
        var _parseDelimiters = parseDelimiters(getContentParts(xmlparsed), delimiters, syntaxOptions), delimiterParsed = _parseDelimiters.parsed, errors = _parseDelimiters.errors;
        var lexed = [];
        var index = 0;
        var lIndex = 0;
        xmlparsed.forEach(function(part) {
...
var require_render = __commonJS({
  "node_modules/docxtemplater/js/render.js"(exports, module) {
    ...
    var _require2 = require_errors();
    var XTScopeParserError = _require2.XTScopeParserError;
    ...
    module.exports = function() {
      ...
      _createClass(XmlTemplater, [{
        ...
        value: function preparse() {
          ...
          var _Lexer$parse = Lexer.parse(this.xmllexed, this.delimiters, this.syntax), lexed = _Lexer$parse.lexed, lexerErrors = _Lexer$parse.errors;
    ...
    var Render = function() {
      ...
      _createClass(Render2, [{
        ...
        value: function render(part, _ref) {
          var contentType = _ref.contentType, scopeManager = _ref.scopeManager, linebreaks = _ref.linebreaks, nullGetter = _ref.nullGetter;
...
//# sourceMappingURL=chunk-PFWZHTDT.js.map
