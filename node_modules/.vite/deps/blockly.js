...
var require_blocks_compressed = __commonJS({
  "node_modules/blockly/blocks_compressed.js"(exports, module) {
    (function(root, factory) {
      ...
      var blocks$$module$build$src$blocks$variables_dynamic = $.createBlockDefinitionsFromJsonArray$$module$build$src$core$common([{ type: "variables_get_dynamic", message0: "%1", args0: [{ type: "field_variable", name: "VAR", variable: "%{BKY_VARIABLES_DEFAULT_NAME}" }], output: null, style: "variable_dynamic_blocks", helpUrl: "%{BKY_VARIABLES_GET_HELPURL}", tooltip: "%{BKY_VARIABLES_GET_TOOLTIP}", extensions: ["contextMenu_variableDynamicSetterGetter"] }, { type: "variables_set_dynamic", message0: "%{BKY_VARIABLES_SET}", args0: [{
        ...
        if (!this.isInFlyout) {
          if ("variables_get_dynamic" === this.type) {
            ...
            b = "variables_get_dynamic", c = $.Msg$$module$build$src$core$msg.VARIABLES_SET_CREATE_GET;
      ...
      var blocks$$module$build$src$blocks$text = $.createBlockDefinitionsFromJsonArray$$module$build$src$core$common([{ type: "text", message0: "%1", args0: [{ type: "field_input", name: "TEXT", text: "" }], output: "String", style: "text_blocks", helpUrl: "%{BKY_TEXT_TEXT_HELPURL}", tooltip: "%{BKY_TEXT_TEXT_TOOLTIP}", extensions: ["text_quotes", "parent_tooltip_when_inline"] }, { type: "text_multiline", message0: "%1 %2", args0: [{
        type: "field_image",
        ...
        updateAt_: function(a, b) {
          ...
          2 === a && $.Msg$$module$build$src$core$msg.TEXT_GET_SUBSTRING_TAIL && (this.removeInput("TAIL", true), this.appendDummyInput("TAIL").appendField($.Msg$$module$build$src$core$msg.TEXT_GET_SUBSTRING_TAIL));
          const c = $.fromJson$$module$build$src$core$field_registry({ type: "field_dropdown", options: this["WHERE_OPTIONS_" + a] });
      ...
      var TEXT_PROMPT_BLOCK$$module$build$src$blocks$text = Object.assign({}, PROMPT_COMMON$$module$build$src$blocks$text, { init: function() {
        ...
        displayRenamedVar_: function(a, b) {
          ...
          if (c && c.bubbleIsVisible()) {
            ...
            for (let d = 0, e; e = c[d]; d++)
              "procedures_mutatorarg" === e.type && $.Names$$module$build$src$core$names.equals(a, e.getFieldValue("NAME")) && e.setFieldValue(b, "NAME");
          }
        },
      ...
      var PROCEDURE_CALL_COMMON$$module$build$src$blocks$procedures = { getProcedureCall: function() {
        ...
        for (var a = 0; a < this.arguments_.length; a++) {
          ...
          if (b) {
            ...
            b = $.fromJson$$module$build$src$core$field_registry({ type: "field_label", text: this.arguments_[a] }), this.appendValueInput("ARG" + a).setAlign($.Align$$module$build$src$core$inputs$input.RIGHT).appendField(
              b,
              "ARGNAME" + a
            ).init();
        }
        ...
        if (a = this.getInput("TOPROW"))
          this.arguments_.length ? this.getField("WITH") || (a.appendField($.Msg$$module$build$src$core$msg.PROCEDURES_CALL_BEFORE_PARAMS, "WITH"), a.init()) : this.getField("WITH") && a.removeField("WITH");
      }, mutationToDom: function() {
        const a = $.createElement$$module$build$src$core$utils$xml("mutation");
        ...
        if (this.workspace && !this.workspace.isFlyout && a.recordUndo)
          if (a.type === $.CREATE$$module$build$src$core$events$utils && -1 !== a.ids.indexOf(this.id)) {
      ...
      var PROCEDURES_IFRETURN$$module$build$src$blocks$procedures = { init: function() {
        ...
        if (!(this.workspace.isDragging && this.workspace.isDragging() || a.type !== $.MOVE$$module$build$src$core$events$utils)) {
          ...
          b ? ("procedures_defnoreturn" === c.type && this.hasReturnValue_ ? (this.removeInput("VALUE"), this.appendDummyInput("VALUE").appendField($.Msg$$module$build$src$core$msg.PROCEDURES_DEFRETURN_RETURN), this.hasReturnValue_ = false) : "procedures_defreturn" !== c.type || this.hasReturnValue_ || (this.removeInput("VALUE"), this.appendValueInput("VALUE").appendField($.Msg$$module$build$src$core$msg.PROCEDURES_DEFRETURN_RETURN), this.hasReturnValue_ = true), this.setWarningText(null)) : this.setWarningText($.Msg$$module$build$src$core$msg.PROCEDURES_IFRETURN_WARNING);
      ...
      var loopTypes$$module$build$src$blocks$loops = /* @__PURE__ */ new Set(["controls_repeat", "controls_repeat_ext", "controls_forEach", "controls_for", "controls_whileUntil"]), CONTROL_FLOW_IN_LOOP_CHECK_MIXIN$$module$build$src$blocks$loops = { getSurroundLoop: function() {
        let a = this;
        do {
          if (loopTypes$$module$build$src$blocks$loops.has(a.type))
            return a;
      ...
      var CONTROLS_IF_MUTATOR_MIXIN$$module$build$src$blocks$logic = {
        ...
        updateShape_: function() {
          ...
          for (a = 1; a <= this.elseifCount_; a++)
            this.appendValueInput("IF" + a).setCheck("Boolean").appendField($.Msg$$module$build$src$core$msg.CONTROLS_IF_MSG_ELSEIF), this.appendStatementInput("DO" + a).appendField($.Msg$$module$build$src$core$msg.CONTROLS_IF_MSG_THEN);
      ...
      var CONTROLS_IF_TOOLTIP_EXTENSION$$module$build$src$blocks$logic = function() {
        this.setTooltip(function() {
          if (this.elseifCount_ || this.elseCount_) {
            ...
            return $.Msg$$module$build$src$core$msg.CONTROLS_IF_TOOLTIP_1;
          return "";
        }.bind(this));
      };
      ...
      var LISTS_GETINDEX$$module$build$src$blocks$lists = {
        init: function() {
          ...
          this.setTooltip(() => {
            ...
            if ("FROM_START" === c || "FROM_END" === c)
              d += "  " + ("FROM_START" === c ? $.Msg$$module$build$src$core$msg.LISTS_INDEX_FROM_START_TOOLTIP : $.Msg$$module$build$src$core$msg.LISTS_INDEX_FROM_END_TOOLTIP).replace("%1", this.workspace.options.oneBasedIndex ? "#1" : "#0");
            return d;
          });
        },
        mutationToDom: function() {
        ...
        updateAt_: function(a) {
          ...
          const b = $.fromJson$$module$build$src$core$field_registry({ type: "field_dropdown", options: this.WHERE_OPTIONS });
      ...
      var LISTS_SETINDEX$$module$build$src$blocks$lists = { init: function() {
        ...
        this.setTooltip(() => {
          ...
          if ("FROM_START" === c || "FROM_END" === c)
            d += "  " + $.Msg$$module$build$src$core$msg.LISTS_INDEX_FROM_START_TOOLTIP.replace("%1", this.workspace.options.oneBasedIndex ? "#1" : "#0");
          return d;
        });
      }, mutationToDom: function() {
      ...
      var module$build$src$blocks$colour = { blocks: blocks$$module$build$src$blocks$colour };
