                    ...
                    <el-row :gutter="0">
                        <el-col :span="8" :xs="8">
                            <el-form-item label="菜单名称" prop="name">
                                <el-input v-model="dataContainer.form.name" placeholder="请输入" clearable @clear="handleQuery"
                        ...
                        <el-col :span="8" :xs="8">
                            <el-form-item label=" ">
                                <el-button type="primary" @click="handleQuery">
                                    <SvgIcon :style="'width:15px;height:15px;margin-right:5px;'" name="svg:search-bt.svg">
                                    </SvgIcon>
                                    查询
                                </el-button>
                                <el-button @click="resetQuery">
                                    <SvgIcon :style="'width:15px;height:15px;margin-right:5px;'" name="svg:redo.svg">
                                    </SvgIcon>
                                    重置
                                </el-button>
                            </el-form-item>
        ...
        <div class="table-box content-container page-content-box">
            <div class="top-container">
                <div class="left">
                    ...
                    <el-button type="info" plain @click="handleSetup">
                        同步到当前系统
                    </el-button>
                </div>
                <div class="right">
            ...
            <div class="table-container">
                <el-table ref="ElTableRef" v-loading="dataContainer.loading" :data="dataContainer.list"
                    ...
                    <el-table-column label="菜单名称" show-overflow-tooltip align="left" min-width="170" prop="title" />
                    <el-table-column label="排序" show-overflow-tooltip align="left" prop="sort" min-width="150" />
                    <el-table-column label="图标" show-overflow-tooltip align="left" prop="iconName" width="80">
                        <template #default="scope">
                            <SvgIcon :style="'width:20px;height:20px;'" :name="scope.row.iconName"></SvgIcon>
                        </template>
                    </el-table-column>
                    <el-table-column label="路由名称" show-overflow-tooltip align="left" prop="name" width="150" />
                    <el-table-column label="路由/链接" show-overflow-tooltip align="left" prop="path" min-width="150" />
                    <el-table-column label="是否缓存" show-overflow-tooltip align="left" prop="isCache" width="100">
                        <template #default="scope">
                            <el-tag v-if="scope.row.isCache">
                                是
                            </el-tag>
                    ...
                    <el-table-column label="是否隐藏" show-overflow-tooltip align="left" prop="hidden" width="100">
                        <template #default="scope">
                            <el-tag v-if="scope.row.hidden">
                                是
                            </el-tag>
                            <el-tag v-else type="info">
                                否
...
import { setMenuData } from "@/action/FormatUserData";
