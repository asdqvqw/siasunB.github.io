<template>
    <div>
        ...
        <div v-if="selected1">
            ...
            <br>
            按钮类型:
            <el-select v-model="selectedcan4" @change="generateJSON">
                <el-option label="非自锁式" value="0"></el-option>
                <el-option label="自锁式" value="1"></el-option>
            </el-select>
        </div>
...
const generateJSON = () => {
    if (selected.value === "1" || selected.value === "2" || selected.value === "4") {
        newRow.value.value = [parseInt(selected.value), parseInt(selectedcan.value), parseInt(selectedcan1.value), parseInt(selectedcan2.value), parseInt(selectedcan3.value), parseInt(selectedcan4.value)]
    } else if (selected.value === "3") {
        newRow.value.value = [parseInt(selected.value), parseInt(selectedcan.value), parseInt(selectedcan1.value), parseInt(selectedcan2.value), parseInt(selectedcan4.value)]
    } else if (selected.value === "5") {
        const decimal = parseInt(selectedcan.value, 16);
        decimalOutput.value = isNaN(decimal) ? '' : decimal.toString();
        newRow.value.value = [parseInt(selected.value), parseInt(decimalOutput.value), parseInt(selectedcan1.value), parseInt(selectedcan4.value)]
    }
...
const putJSON = () => {
    ...
    if (newRow.value.value.value !== undefined) {
        if (newRow.value.value.value[0] === 1 || newRow.value.value.value[0] === 2 || newRow.value.value.value[0] === 4) {
            ...
            selectedcan4.value = newRow.value.value.value[5].toString();
            handleChange();
            ...
            selectedcan1.value = newRow.value.value.value[2].toString();
            selectedcan2.value = newRow.value.value.value[3].toString();
            selectedcan4.value = newRow.value.value.value[4].toString();
            handleChange();
            ...
            // selectedcan.value = newRow.value.value.value[1].toString();
            selectedcan1.value = newRow.value.value.value[2].toString();
            selectedcan4.value = newRow.value.value.value[3].toString();
            handleChange();
        }
        ...
        if (newRow.value.value !== undefined) {
            if (newRow.value.value[0] === 1 || newRow.value.value[0] === 2 || newRow.value.value[0] === 4) {
                ...
                selectedcan4.value = newRow.value.value[5].toString();
                handleChange();
                ...
                selectedcan1.value = newRow.value.value[2].toString();
                selectedcan2.value = newRow.value.value[3].toString();
                selectedcan4.value = newRow.value.value[4].toString();
                handleChange();
               ...
               // selectedcan.value = newRow.value.value[1].toString();
                selectedcan1.value = newRow.value.value[2].toString();
                selectedcan4.value = newRow.value.value[3].toString();
                handleChange();
            }
