<template>
    <div>
      <el-table :data="CANRFID3" style="width: 100%">
...
import { CANRFID3 } from '@/views/agv_ctrl/param/common/commondata.js'
...
const deleteRow = (index) => {
    CANRFID3.value.splice(index, 1);
};

jsondata.value.can3 = {
  ...jsondata.value.can3,
  can_rfid: computed(() => {
    return CANRFID3.value.map((row) => [
