<template>
    <div>
      <el-table :data="CANGUIDE3" style="width: 100%">
...
import { CANGUIDE3 } from '@/views/agv_ctrl/param/common/commondata.js'


const addNewRow = () => {
    CANGUIDE3.value.push({
    ID: '',
    canID: '',
  });
};
...
const deleteRow = (index) => {
    CANGUIDE3.value.splice(index, 1);
};

jsondata.value.can3 = {
  ...jsondata.value.can3,
  can_guide: computed(() => {
    return CANGUIDE3.value.map((row) => [
