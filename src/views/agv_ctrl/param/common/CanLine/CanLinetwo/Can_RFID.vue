<template>
    <div>
      <el-table :data="CANRFID2" style="width: 100%">
...
import { CANRFID2 } from '@/views/agv_ctrl/param/common/commondata.js'
...
const deleteRow = (index) => {
    CANRFID2.value.splice(index, 1);
};

jsondata.value.can2 = {
  ...jsondata.value.can2,
  can_rfid: computed(() => {
    return CANRFID2.value.map((row) => [
