<template>
    <div>
      <el-table :data="CANMANUAL2" style="width: 100%">
...
import { CANMANUAL2 } from '@/views/agv_ctrl/param/common/commondata.js'


const addNewRow = () => {
    CANMANUAL2.value.push({
    ID: '',
    canID: '',
  });
};
...
const deleteRow = (index) => {
    CANMANUAL2.value.splice(index, 1);
};
...
jsondata.value.can2 = {
  ...jsondata.value.can2,
  can_manual: computed(() => {
    return CANMANUAL2.value.map((row) => [
