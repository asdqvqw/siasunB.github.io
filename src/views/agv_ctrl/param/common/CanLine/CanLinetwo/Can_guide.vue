<template>
    <div>
      <el-table :data="CANGUIDE2" style="width: 100%">
...
import { CANGUIDE2 } from '@/views/agv_ctrl/param/common/commondata.js'


const addNewRow = () => {
    CANGUIDE2.value.push({
    ID: '',
    canID: '',
  });
};
...
const deleteRow = (index) => {
    CANGUIDE2.value.splice(index, 1);
};

jsondata.value.can2 = {
  ...jsondata.value.can2,
  can_guide: computed(() => {
    return CANGUIDE2.value.map((row) => [
