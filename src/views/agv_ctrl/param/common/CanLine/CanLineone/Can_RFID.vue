<template>
    <div>
      <el-table :data="CANRFID" style="width: 100%">
...
import { CANRFID } from '@/views/agv_ctrl/param/common/commondata.js'
...
const deleteRow = (index) => {
    CANRFID.value.splice(index, 1);
};

jsondata.value.can1 = {
  ...jsondata.value.can1,
  can_rfid: computed(() => {
    return CANRFID.value.map((row) => [
